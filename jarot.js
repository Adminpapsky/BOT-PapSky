...
mediaType:1,
mediaUrl: 'https://youtube.com/@admin.papsky',
sourceUrl: "https://youtube.com/@admin.papsky"
}}
}
...
case 'tiktoknowm':
			...
			case 'tt':
				...
				let nih = ` 𝘕𝘪𝘩 𝘒𝘢𝘬 from ${author} 𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 https://www.youtube.com/@admin.papsky`
				let buttons = [
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER ADMIN PapSky`,
}
}}), { userJid: m.chat, quoted: doc})
XeonBotInc.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
┏═┅〔 *SUPPORT* 〕┅═
┃⫹⫺ wa.me/6289657779640
┃⫹⫺ youtube.com/@admin.papsky
┃⫹⫺ tiktok.com/@admin.papsky
┗═┅〔 *Made By ADMIN PapSky * 〕┅═`
break
	...
	const sections = [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To ❤️",
										"description": "𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 𝘊𝘩𝘢𝘯𝘦𝘭 ADMIN PapSky`",
										"rowId": `${prefix}tqto`
									}
								]
							}
