...
//owmner v card
global.vcardowner = ['6289657779640'] //ur owner number
global.ownername = "ADMIN PapSky`" //ur owner name
global.developer = "ADMIN PapSky`" //nama lu
global.ytname = "ADMIN PapSky`" //ur yt chanel name
global.socialm = "-" //ur github or insta name
global.sgc = "-"
global.location = "Lampung" //ur location

//bot bomdy 
global.owner = ['6289657779640'] //ur number
global.ownernomer = "6289657779640" //ur number
global.ownertag = '6289657779640' //ur tag number
global.premium = ['6289657779640'] //ur premium number
global.botname = 'ADMIN PapSky`' //ur bot name
global.ownername = "ADMIN PapSky`"
global.linkz = "-" //your theme url which will be displayed on whatsapp
global.dana = "https://link.dana.id/qr/6y04n6eo"
global.pulsa = "+6289657779640"
global.websitex = "-" //ur website to be displayed
global.websitex1 = "-"
global.botscript = 'https://www.youtube.com/@admin.papsky' //script link
global.themeemoji = "⏱️" //ur theme emoji
global.packname = "089657779640" //ur sticker watermark packname
global.author = "YT ADMIN PapSky`" //ur sticker watermark author
global.wm = "089657779640" //ur watermark
